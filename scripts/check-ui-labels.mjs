...
const NOT_A_LABEL = [
  ...
  // Imperative verbs that open a numbered step. Bold marks the instruction,
  // not a control, so these are emphasis rather than labels.
  /^(Build|Read|Open|Wait|Create|Sort|Select|Widen|Narrow)\b/,
